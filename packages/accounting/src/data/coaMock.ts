...
export const MOCK_COA: ChartOfAccount[] = [
  ...
  { id: "1020", name: "Bank - Current Account", type: "asset", category: "Current Asset", normalBalance: "debit", isActive: true },
    { id: "1170", name: "Input Tax Receivable", type: "asset", category: "Current Asset", normalBalance: "debit", isActive: true },
  { id: "1200", name: "Inventories", type: "asset", category: "Current Asset", normalBalance: "debit", isActive: true },
  ...
  { id: "2160", name: "Output Tax Payable (SST/GST)", type: "liability", category: "Current Liability", normalBalance: "credit", isActive: true },
